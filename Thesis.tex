...
\puttitle{
	...
	namedona=Donatello Larocca, % Author Name and Surname
	namelollo=Lorenzo Rapini, % Author Name and Surname
	course=Xxxxxxx Engineering - Ingegneria Xxxxxxx, % Study Programme (in Italian)
	IDdona  = 247972,  % Student ID number (numero di matricola)
	IDlollo  = 000000,  % Student ID number (numero di matricola)
	advisor= Prof. Luca Grilli, % Supervisor name
